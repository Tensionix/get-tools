...
echo ================================================================
echo [INFO] Package: Microsoft Visual C++ 2015-2022 Redistributable (x86)
echo [INFO] ID:      Microsoft.VCRedist.2015+.x86
echo.
...
winget list --id Microsoft.VCRedist.2015+.x86 -e --source winget

echo.
echo ----------------------------------------------------------------
echo [INFO] Fallback exact match without source filter:
winget list --id Microsoft.VCRedist.2015+.x86 -e
