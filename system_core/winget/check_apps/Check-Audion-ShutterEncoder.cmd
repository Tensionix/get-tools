...
echo ================================================================
echo [INFO] Package: Shutter Encoder
echo [INFO] ID:      PaulPacifico.ShutterEncoder
echo.
...
winget list --id PaulPacifico.ShutterEncoder -e --source winget

echo.
echo ----------------------------------------------------------------
echo [INFO] Fallback exact match without source filter:
winget list --id PaulPacifico.ShutterEncoder -e
