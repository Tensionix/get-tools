...
echo [INFO] Package: Microsoft Visual C++ 2005 Redistributable (x86)
echo [INFO] ID: Microsoft.VCRedist.2005.x86
echo.


winget upgrade --id Microsoft.VCRedist.2005.x86 -e --source winget --accept-source-agreements --accept-package-agreements --disable-interactivity
set "RC=%ERRORLEVEL%"
