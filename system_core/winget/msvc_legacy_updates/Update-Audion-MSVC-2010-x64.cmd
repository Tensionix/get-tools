...
echo [INFO] Package: Microsoft Visual C++ 2010 Redistributable (x64)
echo [INFO] ID: Microsoft.VCRedist.2010.x64
echo.


winget upgrade --id Microsoft.VCRedist.2010.x64 -e --source winget --accept-source-agreements --accept-package-agreements --disable-interactivity
set "RC=%ERRORLEVEL%"
