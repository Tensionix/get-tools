...
title Audion Get Tools - Build Portable Env
...
set "REQ_FILE=%INSTALL_DIR%\requirements_gui.in"
...
echo ======================================================================
echo   AUDION GET TOOLS - BUILD PORTABLE ENV
echo ======================================================================
echo Root:       %ROOT%
...
echo [INFO] Falling back to Build_Portable_Env.cmd
...
:ERR_REQ
echo [ERROR] requirements_gui.in was not found.
if not defined AUDION_NO_PAUSE pause
exit /b 1
